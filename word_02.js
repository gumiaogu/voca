...
var Library = {
  ...
  drawLayout: function() {
    ...
    topBox.text(270, 27, '한자 학습 02').attr({
      'font-size': 16
    });
  },
  ...
  drawChoice01: function(params) {
    ...
    for (var i = 0; i < exampleInfo.length; i++) {
      ...
      choices[i].rect(45 + (i % 3) * 95, 170 + (i % 4) * 95, 80, 80, 6, 6).attr({
        'fill': 'white',
        'stroke': '#D67B4E',
        'stroke-width': 1.5
      });
      choices[i].text(85 + (i % 3) * 95, 223 + (i % 4) * 95, exampleInfo[i].hanja).attr({
